import { Procedure, Review } from '../types'
...
export const mockProcedures: Procedure[] = [
  {
    ...
    category: 'Лицо',
    description:
      'Профессиональная чистка лица с использованием современных технологий',
    fullDescription:
      'Глубокая чистка лица с использованием профессиональных средств. Процедура включает очищение пор, удаление черных точек и комедонов, увлажнение и питание кожи.',
    price: 2500,
    duration: 60,
  ...
  },
  {
    ...
    fullDescription:
      'Классический массаж лица, направленный на улучшение кровообращения, лимфодренаж и повышение тонуса кожи. Помогает разгладить мелкие морщины и улучшить цвет лица.',
    price: 2000,
    duration: 45,
  ...
  },
  {
    ...
    fullDescription:
      'Процедура обертывания с использованием специальных составов для борьбы с целлюлитом, улучшения тонуса кожи и выведения лишней жидкости.',
    price: 3000,
    duration: 90,
  ...
  },
  {
    ...
    fullDescription:
      'Современная процедура удаления волос с помощью лазера. Безболезненно, эффективно, долговременный результат.',
    price: 4000,
    duration: 30,
