...
export const submitBooking = async (
  ...
  // Явно сообщаем, что Firebase не настроен. Иначе пользователь получает "успех",
  // но заявка никуда не уходит, что критично для продакшена.
  return {
    success: false,
    message: 'Заявка не отправлена: Firebase не настроен для этого окружения.',
  }
}
